...
namespace Application7.Web.Areas.MenuItems
{
    ...
    public class MenuItemsController : Controller
    {
        ...
        // GET: MenuItems/MenuItems/Details/5
        ...
        // GET: MenuItems/MenuItems/Create
        ...
        public async Task<IActionResult> Create([Bind("MenuItemId,MenuItemName,NumberOfPlates,CategoryId,CategoryName")] MenuItem menuItem)
        {
        ...
        // GET: MenuItems/MenuItems/Edit/5
        ...
        // POST: MenuItems/MenuItems/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuItemId,MenuItemName,NumberOfPlates,CategoryId")] MenuItem menuItem)
        {
        ...
        // GET: MenuItems/MenuItems/Delete/5
        ...
        // POST: MenuItems/MenuItems/Delete/5
